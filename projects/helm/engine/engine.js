...
export function makeCalendar(startISO) {
...
export function expandEvents(seed, events) {
  const out = [];
...
// ─────────────────────────────────────────────────────────────────────────────
export function schedule(seed, rawEvents, today, opts = {}) {
...
export function planDelta(base, cur) {
  const moves = [];
...
export function chartSeries(plan, metric) {
  const pts = [];
...
export function capacity(plan, seed, fromDay, days) {
  const cal = plan.cal;
  const out = [];
