# Project Finance & Structuring Advisory: A Utility-Scale PV Project on a Philippine Island Province
...
- **Technical normalisation.** The client's headline claim of *"80% efficiency"* was imprecise and would have failed technical due diligence. Recalibrated to standard metrics, the asset shows module efficiency **~20–23%**, a performance ratio (PR) of **~0.80**, and a capacity factor (CF) of **~18–21%**. The supplied 1 MW model forecasts **~1,575 MWh in Year 1 — a realistic ~17.9% CF** — a defensible base case rather than an optimistic one.
- **Dilution risk is severe.** Raising USD 2M purely as venture-capital / early-stage *equity* against an asset of this size and contracted cash profile would **over-dilute the founders**, plausibly surrendering **>60% effective control** once institutional execution-risk haircuts are applied.
- **Optimal capital stack.** The pure-equity VC route should be abandoned. The project should be housed in a **special-purpose vehicle (SPV)** and funded with **bank-led project finance** or **sponsor-backed bridge financing**, preserving founder control and lowering the cost of capital against 25 years of contracted PSA cash flows.
- **Foreign ownership is now open; land is not.** Recent reform (DOJ Opinion No. 21, s. 2022, and DOE Department Circular **DC2022-11-0034**) lifted the constitutional 40% foreign-equity cap for solar, permitting **100% foreign ownership of the generating SPV**. Land, however, remains strictly lease-based — extendable to **99 years** under RA 12252.
- **Governance is the gating risk.** Diligence identified a **politically-exposed-person (PEP)** exposure in the ownership chain — a recurring feature of provincial infrastructure financing, and one that must be screened for and structured around before any funds move. Because the sponsor is a US person, this creates direct **US Foreign Corrupt Practices Act (FCPA)** risk, compounded by relationship-driven permitting. Stringent anti-bribery / anti-corruption (ABAC) controls are required before institutional or US capital will engage.

## 2. Project Snapshot & Assets

| Location & grid | Land status | Offtake agreement |
| --- | --- | --- |
...
- **Module efficiency (~20–23%).** The share of incident sunlight the physical panel converts to DC electricity.
- **Performance ratio (PR, ~0.80).** Almost certainly what the "80%" actually referred to. PR captures *system losses* — inverter inefficiency, wiring and mismatch, soiling, and temperature degradation. A PR of 0.80 means the system delivers 80% of what it could theoretically produce under local irradiance.
- **Capacity factor (CF, ~18–21%).** The single most important metric for financial modelling: actual annual AC energy divided by the theoretical maximum if the plant ran at 100% nameplate, 24/7. Sunny-region utility PV clusters around **~20%** globally.
...
| 1 MW CAPEX | 1 MW O&M / yr | Tariff assumption | Payback period |
| --- | --- | --- | --- |
...
| | Pure-equity / VC raise | Debt-led structure (recommended) |
| --- | --- | --- |
| Founder control after raise | <40% (severe dilution) | Retained |
| Cost of capital | High (equity risk premium) | Lower (secured, amortising) |
| Fit to a 25-yr contracted asset | Poor | Strong |
| Speed | Faster to cash | Slower; heavy due diligence |
...
- **Baseline (RA 7652):** qualifying foreign investors could lease private land up to 50 years, renewable once for 25 (total 75 years).
- **Updated reform (RA 12252):** extends allowable leases for qualifying registered investments to **up to 99 years**.
...
**1. Philippine bank project finance — *recommended.*** Senior secured debt via the local banking system; requires assignment of receivables, share pledges, mortgages and DSRA accounts.
*Pros:* lowest dilution; aligns with long-term infrastructure economics. *Cons:* slow execution; immense due-diligence requirements.

**2. Foreign-lender USD debt.** Offshore borrowing; requires Bangko Sentral ng Pilipinas (BSP) registration — a Bangko Sentral Registration Document (BSRD) — to service the FX loan legally through the domestic banking system.
*Pros:* deeper USD liquidity; matches USD-linked CAPEX. *Cons:* country / convertibility risk; heavy FX-reporting discipline.

**3. Asset-backed bridge financing.** Corporate-recourse loan secured by the sponsor's *existing* portfolio (e.g., hotel cash flows) to bridge to bankability milestones.
*Pros:* fastest path to cash; funds early-stage development risk. *Cons:* concentrates risk heavily on the sponsor's balance sheet.

**4. DFI / blended finance.** Institutions such as the Asian Development Bank (ADB), the International Finance Corporation (IFC), or the US International Development Finance Corporation (DFC — highly relevant for a US sponsor) offering debt, guarantees or political-risk wraps.
*Pros:* de-risks syndication; excellent terms. *Cons:* extremely intense ESG / integrity due diligence; slow.

**5. Green / sustainability bonds.** Capital-markets route utilising SEC guidelines that adopt the ASEAN Green Bond Standards.
*Pros:* large ticket sizes; reputational upside. *Cons:* unsuited to a single early-stage project.

**6. Government incentives & tax.** The RE Act framework (VAT zero-rating, 7-year income-tax holiday). Not direct financing, but it materially improves DSCR sizing.
*Pros:* improves returns without equity dilution. *Cons:* strict BIR / DOE endorsement compliance.
...
- **SPV incorporation:** 100% US ownership verified against DOJ Op. 21 / DC2022-11-0034.
- **ABAC policies enacted:** gifts / hospitality controls, third-party due diligence, PEP screening and declarations, document-retention discipline.
- **Traceable procurement:** clean, traceable payments — increasingly a hard requirement under Philippine banks' tightened integrity climate.
- **DOE RE contract awarded** (COA issued).
- **Interconnection agreement signed** (the cooperative).
- **ERC PSA approval** cleared (a document-heavy consumer-protection process).

## 10. Execution Plan (Next 90 Days)

**Days 1–30.**
- Restructure the pitch deck to project-finance metrics — remove *"80% efficiency"* and present PR / CF properly.
- Clean up governance: formalise PEP declarations and obtain FCPA legal opinions on any proposed official interest (or remove it).
- Engage a technical adviser for a formal P50 / P90 yield study.

**Days 31–60.**
- Initiate grid-interconnection feasibility with the cooperative.
- Secure the DOE Certificate of Authority (COA) to begin formal permitting.
- Prepare the legal data room and register the land lease (aiming for the RA 12252 maximum term).

**Days 61–90.**
- Circulate teasers to regional commercial banks (e.g., BDO, BPI, Security Bank) for project debt.
- Alternatively, execute sponsor-backed bridge documentation using external asset collateral to push the project to Notice to Proceed (NTP).
